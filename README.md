...
1. 仓库开启 Discussions  
2. 打开 [giscus.app](https://giscus.app) 按提示生成配置  
3. 写入环境变量：

| 变量 | 说明 |
|------|------|
| `NEXT_PUBLIC_GISCUS_REPO` | 如 `xiaoqianran/Web001-Blog` |
| `NEXT_PUBLIC_GISCUS_REPO_ID` | giscus 提供的 repo id |
| `NEXT_PUBLIC_GISCUS_CATEGORY_ID` | Discussions 分类 id |
| `NEXT_PUBLIC_GISCUS_CATEGORY` | 可选，默认 `Announcements` |
